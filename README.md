...
Why: Naming rules are enforced by the parser before your code ever runs — knowing the boundaries avoids SyntaxErrors and keeps code readable across a team.
 ...
 */
var g = 10; // cmd + /, ctrl + /
Full identifier rules + naming convention tables live in IQ_Notes/01_Identifier_Rules.md.
...
IQ_Notes — Reference Library
Concept explainers, generated on demand via the prompt template in IQ_Notes/README.md — table breakdown, code walkthrough, pipeline diagram, TL;DR.

File	Covers
Source_Code_ByteCODE_Binary_IQ.md	Source code vs bytecode vs binary/machine code, V8 compilation pipeline
01_Identifier_Rules.md	Legal identifier characters, case sensitivity, naming conventions
02_Keyword_Notes.md	Every JS reserved keyword, grouped by category
03_commands_mac.md	VS Code keyboard shortcuts — macOS
03_commands_win.md	VS Code keyboard shortcuts — Windows
